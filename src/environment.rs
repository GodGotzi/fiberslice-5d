...
impl HandleOrientation for OrbitCamera {
    fn handle_orientation(&mut self, orientation: Orientation) {
        let (distance, yaw, pitch) = match orientation {
            Orientation::Default => (2.0, -PI / 4.0, PI / 4.0),
            Orientation::Diagonal => (2.0, -PI / 4.0, PI / 4.0),
            Orientation::Top => (2.0, 0.0, PI / 2.0),
            Orientation::Left => (2.0, -PI / 2.0, 0.0),
            Orientation::Right => (2.0, PI / 2.0, 0.0),
            Orientation::Front => (2.0, 0.0, 0.0),
        };
